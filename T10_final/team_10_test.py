...
class TestHospital(unittest.TestCase):
    ...
    def test_remove_worker(self):
        ...
        db.write(string)
        db.close()
        self.assertTrue(team_10.remove_worker_from_database("123456", "testing_remove.txt"),
                        "The employee was found and deleted")
        self.assertFalse(team_10.remove_worker_from_database("987654", "testing_remove.txt"),
                         "ID of a clerk and not a cleaning worker")
